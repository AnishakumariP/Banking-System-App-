...
<body>
	...
	<div class="container">
		...
		<div class="result">
			...
			<p>You successfully Rs.<c:out value="${amount}"/> transferred to account <c:out value="${target }"/>...</p>
			<p style="font-size: 14px;">Now here is your total balance and some details..</p>
			<br> 
			<table border="1">
				<tr>
					<th>Account No.</th>
