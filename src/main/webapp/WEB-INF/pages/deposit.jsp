...
<body>
	...
	<div class="container">
		...
		<div class="result">
			...
			<p>You successfully Rs.<c:out value="${amount}"/> deposited...</p><br> 
			<table border="1">
				<tr>
					<th>Account No.</th>
					<th>Holder Name</th>
				...
				<tr>
					...
					<!--  <td>$<c:out value="{deposit.accountno}"/></td>
					<td>$<c:out value="{deposit.holder_name}"/></td>
					<td>$<c:out value="{deposit.amount}"/></td>
					<td>$<c:out value="{deposit.email}"/></td>
					<td>$<c:out value="{deposit.email}"/></td> -->
					<td>${deposit.accountno }</td>
					<td>${deposit.holder_name }</td>
